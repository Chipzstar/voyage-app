...
const Trips = ({ loads, statuses = Object.values(STATUS), message }: TripsProps) => {
	...
	return (
		<ContentContainer classNames='px-6 py-2'>
			...
			<DataGrid offset={50} activePage={activePage} setPage={setPage} rows={rows} headings={['Trip ID', 'Status', 'Controller', 'Driver', 'Last Updated', 'Source', 'Tracking']} emptyContent={<Empty message={message} />} />
		</ContentContainer>
	);
};
